    ...
    <div className="screen" data-active="true">
      <div className="max-w-[1400px] mx-auto px-8 pt-10 pb-20">
        ...
        <div className="grid grid-cols-12 gap-3 mt-12">
          {[
            { k:'GPA',         v:s.gpa.toFixed(2), max:4,    ring:Math.round((s.gpa/4)*100), unit:'cumulative', color:'#13110E' },
            { k:'Attendance',  v:s.attendance+'%', max:100,  ring:s.attendance,               unit:'last 4 weeks', color:'#3F6B3F' },
            { k:'On-time',     v:s.ontime+'%',     max:100,  ring:s.ontime,                   unit:'submission window', color:'#D2532A' },
            { k:'Credits',     v:'18',             max:24,   ring:Math.round((18/24)*100),    unit:'this term', color:'#7A2E12' },
          ].map(t=>(
          ...
          <div className="grid grid-cols-12 gap-8 items-start">
            ...
            <div className="col-span-12 lg:col-span-4">
              ...
              <div className="bg-paper/5 rounded p-4">
                <LineChart data={s.trend} w={420} h={180} color="#D2532A" axis={false} fill={false}/>
              </div>
            ...
            {s.courses.map(c=>{
              ...
              return (
                <div key={c.code} className="col-span-12 md:col-span-6 lg:col-span-4 bg-paper2/60 border border-rule rounded p-5 lift">
                  ...
                  <div className="mt-3">
                    <Bar value={c.mark} color={c.mark>=85?'#3F6B3F':c.mark>=72?'#13110E':'#B8842B'} height={3}/>
                  </div>
                </div>
              );
            })}
