...
export const UCAR_INSTITUTIONS: PublicInstitution[] = [
  // ── Tunis cluster ──────────────────────────────────────────────
  {
    ...
    description: 'Pôle de référence en droit, sciences politiques et sciences sociales. Couvre les domaines juridiques publics et privés.',
  ...
  },
  {
    ...
    description: 'Seule école nationale d\'architecture en Tunisie. Leader en design urbain et patrimoine architectural méditerranéen.',
  ...
  },
  {
    ...
    description: 'Formation d\'élite en statistiques, data science et analyse d\'information. Forte demande sur le marché tunisien et international.',
  ...
  },
  {
    ...
    description: 'Institut d\'excellence en ingénierie et technologies appliquées. Classé parmi les meilleures écoles d\'ingénieurs de Tunisie.',
    specialties: ['Génie logiciel', 'Réseaux', 'Automatique', 'Mécanique'],
    healthStatus: 'warning',
  },
  {
    id: 'isteeub', acronym: 'ISTEEUB', name: 'Technologies Environnement Bâtiment',
    ...
    description: 'Formation en génie civil, bâtiment et développement durable. Lien fort avec les acteurs du secteur de la construction.',
  ...
  },
  {
    ...
    description: 'Pôle de formation linguistique et traduction. Offre une gamme complète de langues vivantes et de communication interculturelle.',
  ...
  },
  {
    ...
    description: 'Formation et recherche en industries agroalimentaires. Partenariats actifs avec les industries de transformation en Tunisie.',
  ...
  },
  {
    ...
    description: 'Formation en ressources humaines, relations du travail et protection sociale. Partenariats avec le ministère des Affaires sociales.',
  ...
  },
  {
    ...
    description: 'Seul établissement tunisien dédié à la formation des professionnels de l\'enfance et de la petite enfance.',
  ...
  },
  {
    ...
    city: 'Tunis', type: 'ecole_agro', pin: { x: 163, y: 104 },
    ...
    description: 'Le plus ancien établissement d\'enseignement supérieur agronomique de Tunisie. Reconnu à l\'échelle africaine et méditerranéenne.',
    specialties: ['Agronomie', 'Eaux et forêts', 'Économie rurale', 'Biotechnologie végétale'],
    healthStatus: 'good',
  },
  {
    id: 'ingref', acronym: 'INGREF', name: 'Génie Rural Eau Forêt',
    ...
    description: 'Institut de recherche stratégique en gestion de l\'eau, des forêts et du génie rural. Publications reconnues internationalement.',
  ...
  },
  {
    ...
    description: 'Centre de recherche phare en Afrique du Nord pour les sciences agronomiques. Développement de variétés adaptées au changement climatique.',
  ...
  // ── Ariana / Suburb ──────────────────────────────────────────────
  {
    ...
    description: 'École d\'élite en télécommunications et technologies numériques. Taux d\'employabilité parmi les plus élevés du réseau UCAR.',
  ...
  },
  {
    ...
    description: 'Classe préparatoire en biologie et géologie. Voie d\'accès aux grandes écoles scientifiques tunisiennes.',
  ...
  // ── La Marsa / Carthage / Gammarth ───────────────────────────────
  {
    ...
    description: 'Grande école d\'ingénieurs, référence nationale en formation scientifique et technologique de haut niveau.',
  ...
  },
  {
    ...
    description: 'Classe préparatoire d\'excellence scientifique. Un des meilleurs taux d\'intégration aux grandes écoles du pays.',
    specialties: ['Mathématiques', 'Physique', 'Informatique', 'MPSI/PCSI'],
    healthStatus: 'good',
  },
  {
    id: 'esti', acronym: 'ESTI', name: 'Technologie & Informatique Carthage',
    ...
    description: 'Formation en informatique appliquée et nouvelles technologies. Ancré dans l\'écosystème technologique de Carthage.',
    specialties: ['Développement logiciel', 'IA', 'Réseaux', 'Cloud computing'],
    healthStatus: 'good',
  },
  {
    id: 'ihec', acronym: 'IHEC', name: 'Hautes Études Commerciales Carthage',
    ...
    description: 'Grande école de management et commerce international. Double diplôme avec plusieurs universités européennes.',
  ...
  },
  {
    ...
    description: 'Seule école dédiée au cinéma et à l\'audiovisuel en Tunisie. Festivals et coproductions méditerranéennes.',
    specialties: ['Réalisation', 'Montage', 'Production', 'Photographie', 'Animation'],
    healthStatus: 'good',
  },
  // ── Borj Cédria / Sidi Dhrif ──────────────────────────────────────
  {
    id: 'isste', acronym: 'ISSTE', name: 'Sciences & Technologies Environnement Borj Cédria',
    ...
    description: 'Recherche et enseignement en sciences environnementales. Situé au technopôle de Borj Cédria.',
    specialties: ['Environnement', 'Énergie renouvelable', 'Écologie', 'Chimie verte'],
    healthStatus: 'good',
  },
  {
    id: 'ihet', acronym: 'IHET', name: 'Hautes Études Touristiques Sidi Dhrif',
    ...
    description: 'Formation en tourisme, hôtellerie et patrimoine culturel. Cadre exceptionnel sur la côte de la Marsa.',
  ...
  // ── Bizerte cluster ──────────────────────────────────────────────
  {
    ...
    description: 'Faculté des sciences fondamentales à Bizerte. Forte orientation recherche et passerelles vers les grandes écoles.',
  ...
  },
  {
    ...
    description: 'Classe préparatoire en ingénierie à Bizerte. Accès aux grandes écoles d\'ingénieurs de toute la Tunisie.',
    specialties: ['Mathématiques', 'Physique', 'Sciences de l\'ingénieur'],
    healthStatus: 'good',
  },
  {
    id: 'isccb', acronym: 'ISCCB', name: 'Commerce et Comptabilité Bizerte',
    ...
    description: 'Formation en sciences comptables, audit et gestion. Fort ancrage dans le tissu économique de la région de Bizerte.',
    specialties: ['Comptabilité', 'Audit', 'Gestion', 'Finance d\'entreprise'],
    healthStatus: 'good',
  },
  {
    id: 'ispab', acronym: 'ISPAB', name: 'Pêche et Aquaculture Bizerte',
    fullName: "Institut Supérieur de Pêche et d'Aquaculture de Bizerte",
    city: 'Bizerte', type: 'ecole_agro', pin: { x: 131, y: 53 },
    ...
    description: 'Unique établissement tunisien dédié à la pêche et l\'aquaculture. Situation idéale face au lac de Bizerte.',
    specialties: ['Aquaculture', 'Pêche maritime', 'Sciences halieutiques', 'Environnement marin'],
    healthStatus: 'good',
  },
  // ── Mateur ────────────────────────────────────────────────────────
  {
    id: 'issat', acronym: 'ISSAT', name: 'Sciences Appliquées Mateur',
    ...
    description: 'Formation technologique polyvalente au cœur de la région de Bizerte. Lien direct avec les zones industrielles de Mateur.',
    specialties: ['Génie électrique', 'Mécanique', 'Informatique industrielle', 'Maintenance'],
    healthStatus: 'good',
  },
  {
    id: 'esamat', acronym: 'ESA Mateur', name: 'Agriculture Mateur',
    ...
    description: 'École d\'agronomie de référence dans le nord-ouest tunisien. Spécialisée en grandes cultures et productions végétales.',
  ...
  // ── Nabeul / Cap Bon ─────────────────────────────────────────────
  {
    ...
    description: 'Faculté de gestion desservant le Cap Bon et la région côtière. Partenariats avec le secteur touristique et les PME locales.',
  ...
  },
  {
    ...
    description: 'Classe préparatoire ingénierie dans la région du Cap Bon. Proximité avec les industries de la zone de Nabeul.',
  ...
  },
  {
    ...
    description: 'Espace de création et d\'expression artistique. Tradition céramique de Nabeul intégrée dans les parcours de formation.',
    specialties: ['Peinture', 'Sculpture', 'Céramique', 'Arts numériques'],
    healthStatus: 'good',
  },
  {
    id: 'islain', acronym: 'ISLAIN', name: 'Langues et Informatique Nabeul',
    ...
    description: 'Double compétence langues et informatique. Profils très demandés dans les centres d\'appel et le secteur numérique.',
    specialties: ['Anglais', 'Informatique', 'Traduction technique', 'Commerce électronique'],
    healthStatus: 'good',
  },
  // ── Mograne ──────────────────────────────────────────────────────
  {
    id: 'esam', acronym: 'ESA Mograne', name: 'Agriculture Mograne',
    ...
    description: 'Doyenne des écoles d\'agronomie tunisiennes, fondée au début du XXe siècle. Expertise reconnue en viticulture et arboriculture.',
