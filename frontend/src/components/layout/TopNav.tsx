...
const NAV_BY_ROLE: Record<Role | 'public', NavItem[]> = {
  ...
  ucar_central: [
    ...
    { labelKey: 'Classement',    href: '/rankings' },
    { labelKey: 'Alertes',       href: '/alerts' },
    { labelKey: 'Rapports IA',   href: '/reports' },
    { labelKey: 'Prévisions',    href: '/forecasts' },
    { labelKey: 'Téléversement', href: '/upload' },
    { labelKey: 'Orchestrateur', href: '/orchestrator' },
