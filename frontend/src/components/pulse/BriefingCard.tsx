    ...
    <>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto bg-paper border-rule">
          <DialogHeader>
            <DialogTitle className="font-display text-ink">Briefing complet — {briefing.weekLabel}</DialogTitle>
            <DialogDescription className="text-ink3">Analyse générée automatiquement par CarthaVillage Intelligence</DialogDescription>
          </DialogHeader>
